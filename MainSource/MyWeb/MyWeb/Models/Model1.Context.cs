...
namespace MyWeb.Models
{
    ...
    public partial class thuctapk39Entities : DbContext
    {
        ...
        public virtual int Class_SearchFee(string info)
        {
            var infoParameter = info != null ?
                new ObjectParameter("Info", info) :
                new ObjectParameter("Info", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Class_SearchFee", infoParameter);
        }
    
        public virtual int Class_SearchName(string info)
        {
            var infoParameter = info != null ?
                new ObjectParameter("Info", info) :
                new ObjectParameter("Info", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Class_SearchName", infoParameter);
        }
        ...
        public virtual int Teacher_SearchName(string info)
        {
            var infoParameter = info != null ?
                new ObjectParameter("Info", info) :
                new ObjectParameter("Info", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Teacher_SearchName", infoParameter);
        }
    
        public virtual int Teacher_SearchPhone(string info)
        {
            var infoParameter = info != null ?
                new ObjectParameter("Info", info) :
                new ObjectParameter("Info", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Teacher_SearchPhone", infoParameter);
        }
