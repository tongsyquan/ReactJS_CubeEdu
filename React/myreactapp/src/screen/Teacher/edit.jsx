...
import {Input, Modal, Select,DatePicker,Form,Button, Radio, Upload, Tabs,Table, Row,Col,Card,Tag,} from "antd";
...
export default class Teacher extends Component {
  ...
  getClassTimeTable = (id) => {
    APIHelper.get("Teacher/GetClassTimeTables?id=" + id).then((data) => {
      this.setState({
        lstDate: data,
      });
  ...
  handleOk = () => {
    ...
    APIHelper.post("Teacher/Update", this.state.data).then((newData) => {
      if (newData == true) {
        Modal.success({
          content: "Success",
        });
          ...
          <Tabs defaultActiveKey="1" onChange={callback}>
            <TabPane tab="Staff Information" key="1">
              <Tabs tabPosition="left" defaultActiveKey="1" onChange={callback}>
                ...
                <TabPane tab="Timekeeping" key="2"></TabPane>
                  ...
                  <Row>
                    <Col span={12}>
                      <div style={{ paddingTop: "0px", width: "100px" }}>
                        <label style={{ fontWeight: "bold" }}>Start Day</label>
                        <DatePicker
                          style={{
                            width: "430px",
                          }}
                          value={moment.utc(item.BeginDate)}
                          format="DD-MM-YYYY"
                          onChange={(e) => {
